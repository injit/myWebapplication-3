        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="peopleGridView" runat="server"  HeaderStyle-CssClass="gridViewHeader" AllowSorting ="True" BackColor="White"  DataKeyNames="emplid"
                    ...
                    OnRowDeleting="peopleGridView_RowDeleting" OnRowCancelingEdit="peopleGridView_RowCancelingEdit"  >
                    <AlternatingRowStyle BackColor="White"  />

                        <Columns>

                            <asp:CommandField  ButtonType="Button" ShowEditButton ="true"  ShowDeleteButton="true"  HeaderStyle-CssClass="cmdHeader"  HeaderText="Click To"  > 
